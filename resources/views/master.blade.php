...
<head>
  ...
  <meta name="description" content="Learn new skills and take your career to the next level with our comprehensive online academy. Our expert instructors and interactive course materials will help you master HTML, CSS, JavaScript, and more.">
  <meta name="keywords" content="web development, online academy, HTML, CSS, JavaScript, coding">
  <meta name="robots" content="index, follow">
  <meta name="author" content="Academy Team">
  <meta name="author" content="Xpertbot Academy">
		...
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6 col-md-6">
				<div class="widget footer-widget mb-5 mb-lg-0">
					...
					<p class="mt-3">Our training center offers a comprehensive program for students to gain valuable skills in the tech industry, including web development, quality assurance, project management, and graphic design. Explore these diverse tracks to discover your passions and become a valuable asset to any tech company.</p>
					<ul class="list-inline footer-socials">
						<li class="list-inline-item"><a target="_blank" href="https://www.linkedin.com/company/xpertbot/"><i class="fab fa-linkedin"></i></a></li>
						<li class="list-inline-item"><a target="_blank" href="https://www.instagram.com/xpertbotacademy2023/"><i class="fab fa-instagram"></i></a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row justify-content-center align-items-center">
				...
				<div class="col-lg-6">
					<div class="copyright text-lg-center">
						<p>@ Copyright reserved to Xpertbot.</p>
					</div>
				</div>
			</div>
		</div>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2W3P2YNF8P"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2W3P2YNF8P');
</script>
