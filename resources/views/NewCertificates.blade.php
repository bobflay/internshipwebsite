<html>
    ...
    <body>
        @if(auth()->user())
        <div>
            <a href="https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=XpertBot {{$role}}&organizationId=20546595&issueYear=2023&issueMonth=10&certUrl=https://xpertbotacademy.online/certificates/{{$student->uuid}}&certId={{$student->uuid}}&skills=Laravel,Git">
